...
library(jpeg)
library(magick)
pm <- read.csv("C:\\Users\\howel\\OneDrive\\Desktop\\PhotoRecognitation Project\\photoMetaData.csv")
...
for (j in 1:n) {
  img <- readJPEG(paste0("C:\\Users\\howel\\OneDrive\\Desktop\\PhotoRecognitation Project\\columbiaImages\\",pm$name[j]))
